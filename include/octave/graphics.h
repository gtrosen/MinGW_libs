...
public:
  ...
  std::string get_errormessage (void) const { return errormessage.string_value (); }
...
public:
  ...
  enum
  {
    ...
    ID_NEXTPLOT = 3032,
    ID_OUTERPOSITION = 3033,
    ID_PLOTBOXASPECTRATIO = 3034,
    ID_PLOTBOXASPECTRATIOMODE = 3035,
    ID_POSITION = 3036,
    ID_PROJECTION = 3037,
    ID_TICKDIR = 3038,
    ID_TICKDIRMODE = 3039,
    ...
    ID_XTICK = 3055,
    ID_XTICKLABEL = 3056,
    ID_XTICKLABELMODE = 3057,
    ID_XTICKMODE = 3058,
    ID_YAXISLOCATION = 3059,
    ID_YCOLOR = 3060,
    ID_YDIR = 3061,
    ID_YGRID = 3062,
    ID_YLABEL = 3063,
    ...
    ID_ZTICK = 3082,
    ID_ZTICKLABEL = 3083,
    ID_ZTICKLABELMODE = 3084,
    ID_ZTICKMODE = 3085,
    ID___HOLD_ALL__ = 3086,
    ID_AUTOPOS_TAG = 3087,
    ID_LOOSEINSET = 3088,
    ID_X_VIEWTRANSFORM = 3089,
    ID_X_PROJECTIONTRANSFORM = 3090,
    ID_X_VIEWPORTTRANSFORM = 3091,
    ID_X_NORMRENDERTRANSFORM = 3092,
    ID_X_RENDERTRANSFORM = 3093,
    ID_XMTICK = 3094,
    ID_YMTICK = 3095,
    ID_ZMTICK = 3096
  };
